    ...
    public class StudentEditor : UnityEditor.Editor
    {
        ...
        private void StudentCard()
        {
            using (new EditorGUILayout.VerticalScope("Box"))
            {
                ...
                GUILayout.FlexibleSpace();
                stu.BcklgPortrait = CustomSpriteField(stu.BcklgPortrait);
                GUILayout.FlexibleSpace();
        ...
        private static Sprite CustomSpriteField(Sprite texture)
        {
            using (new EditorGUILayout.VerticalScope())
            {
                ...
                return (Sprite)EditorGUILayout.ObjectField(texture, typeof(Sprite), false, GUILayout.Width(240), GUILayout.Height(120));
            }
        }
