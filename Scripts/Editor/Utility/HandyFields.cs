...
namespace DREditor.Utility.Editor
{
    ...
    public static class HandyFields
    {
        ...
        public static string StringField(string name, string value, int width = 200)
        {
            GUI.backgroundColor = Color.white;
            string result;
            using (new EditorGUILayout.HorizontalScope())
        ...
        public static void UISplitter(Color color, float thickness = 1, int horizontalpadding = 5, int verticalpadding = 10)
        {
