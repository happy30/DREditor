...
namespace DREditor.Dialogues
{
    public abstract class DialogueBase : ScriptableObject
    {
        ...
        public DRPlaylist MusicPlaylist;
    ...
    public class Line
    {
        ...
        public List<DialogueEvent> DiaEvents = new List<DialogueEvent>();
        ...
        //Distrust-specific variables below. Will remove this when fully migrated to DialogueEvents. -SeleniumSoul
